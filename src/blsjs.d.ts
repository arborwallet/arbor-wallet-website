...
export declare class InsecureSignature {
    static SIGNATURE_SIZE: number;

    static fromBytes(bytes: Uint8Array): InsecureSignature;
...
export declare class Signature {
    ...
    static fromBytesAndAggregationInfo(
        bytes: Uint8Array,
...
export declare class AggregationInfo {
    static fromMsgHash(
        publicKey: PublicKey,
    ...
    static fromBuffers(
        pubKeys: PublicKey[],
        msgHashes: Uint8Array[],
        exponents: Uint8Array[]
    ): AggregationInfo;
...
export declare class ChainCode {
    ...
    static fromBytes(bytes: Uint8Array): ChainCode;
...
export declare class Threshold {
    ...
    static aggregateUnitSigs(
        signatures: InsecureSignature[],
        message: Uint8Array,
        players: number[]
    ): InsecureSignature;

    static verifySecretFragment(
        playerIndex: number,
        secretFragment: PrivateKey,
        commitment: PublicKey[],
        threshold: number
    ): boolean;
}

export declare interface BLS {
    ...
    DHKeyExchange(privateKey: PrivateKey, publicKey: PublicKey): any;
    GROUP_ORDER: string;
}

export declare function createModule(options?: {}): Promise<BLS>;
